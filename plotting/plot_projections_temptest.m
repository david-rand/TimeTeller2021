function plot_projections_Bjarn(excluded_probes,type)
...
pm=probabilty_model_construct(clockOMstrN,Inx,[1:10],{'am8','midday','pm4','pm8','midnight','am4'},data_times,24,7.5,type);
